  ...
  <div class="flex justify-center items-start text-gray-800">
    <div class="border p-5 w-full sm:max-w-96">
      ...
      <div class="flex justify-between gap-2 mb-2">
        <select class="text-xs border w-full rounded-full px-2 font-semibold">
        ...
        <div class="flex justify-center items-center gap-2">
          <button class="p-1 border rounded-full bg-gray-400/5">
            <Icon
          ...
          <div class="px-2 border rounded-full py-1 text-xs font-semibold">
            2/3
          </div>
          <button class="p-1 border rounded-full bg-gray-400/5">
            <Icon
